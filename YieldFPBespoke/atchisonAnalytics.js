    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    <h1>Yield FP - Bespoke Portfolio</h1>
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Yield FP - Bespoke Portfolio delivered 2.4% for the month, and 3.5% over the quarter. </p>
                    <p>Over the last 12 months, the Yield FP - Bespoke Portfolio delivered 15.1%, significantly beating Inflation by 12.1%. 
                    Relative to the Peer Group (FE AMI Peer Average), Yield FP - Bespoke Portfolio has materially underperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Yield FP - Bespoke Portfolio has delivered 11.4%, significantly beating Inflation by 8.2%. 
                    Relative to the Peer Group (FE AMI Peer Average), Yield FP - Bespoke Portfolio has  underperformed since inception of the strategy. </p>
