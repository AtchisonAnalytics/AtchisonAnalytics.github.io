    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    <h1>Yield FP - Low Cost Portfolio</h1>
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Yield FP - Low Cost Portfolio delivered 3.2% for the month, and 5.2% over the quarter. </p>
                    <p>Over the last 12 months, the Yield FP - Low Cost Portfolio delivered 19.3%, significantly beating Inflation by 16.4%. 
                    Relative to the Peer Group (FE AMI Peer Average), Yield FP - Low Cost Portfolio has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Yield FP - Low Cost Portfolio has delivered 13.8%, significantly beating Inflation by 10.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Yield FP - Low Cost Portfolio has  outperformed since inception of the strategy. </p>
