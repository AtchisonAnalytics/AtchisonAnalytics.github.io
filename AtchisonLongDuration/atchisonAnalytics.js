        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Atchison Active Long Duration SMA delivered 1.1% for the month, and 3.5% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active Long Duration SMA delivered 5.2%,  beating Inflation by 1.8%. 
                    ...
                    <p>Since inception of the strategy, the Atchison Active Long Duration SMA has delivered 5.0%,  beating Inflation by 0.9%. 
