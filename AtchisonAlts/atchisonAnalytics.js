    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active Alternatives SMA as at 31 March 2025</h2>
                    ...
                    <p>The Atchison Active Alternatives SMA delivered 0.5% for the month, and 3.9% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active Alternatives SMA delivered 11.4%, significantly beating Inflation by 9.1%. 
                    ...
                    <p>Since inception of the strategy, the Atchison Active Alternatives SMA has delivered 8.8%, significantly beating Inflation by 5.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Active Alternatives SMA has significantly outperformed since inception of the strategy. </p>
                    <h4>Key Contributors, Detractors & Attribution</h4>
                    <ul><li>On a weighted basis, the largest holding contributor to the portfolio outcome has been iShares Physical Gold ETF</li><li>The holding that contributed the least to portfolio return was Invesco Wholesale Senior Secured Income Fund</li><li>The current holding with the highest absolute return has been VanEck Global Listed Private Equity ETF<li>Whilst the current holding with the lowest absolute return has been Franklin K2 Athena Fund</li></ul>
                    <p></p><p>Invesco's Senior Secured Loan are the most senior part of the capital structure and are secured (or backed) by the borrowing company's assets. Senior secured loans can deliver consistent income stream above the cash rate whilst also providing risk-adjusted returns. Of companies that default, recoveries are very high due to senior secured loans holders being paid before all other security holders in the capital structure. </p><p></p><p>K2, established in 1994. Market-neutral, alternative risk premia strategies for defensive diversification with low correlation to traditional asset classes.
Correlation 18th June 2021 to 31st July 2024: -39% S&P500, -37% MSCI World, -50% Nasdaq 100, -42% Bloomberg Global Agg
Volatility 18th June 2021 to 31st July 2024: -16.8% S&P500, 14.7% MSCI World, 22.8% Nasdaq 100, 6.4% Bloomberg Global Agg, K2 Athena Fund 4.42%</p>
