        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+15.54%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.79%)</li><li>The asset class with the highest absolute return was International Shares (+64.04%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+12.57%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+2.54%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.80%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
