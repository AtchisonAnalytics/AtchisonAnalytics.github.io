    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 70 SMA as at 31 October 2025</h2>
                    ...
                    <p>The Atchison Active 70 SMA delivered 1.1% for the month, and 3.1% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 70 SMA delivered 10.4%, significantly beating Inflation by 8.0%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+15.97%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.72%)</li><li>The asset class with the highest absolute return was International Shares (+66.42%)</li><li>Whilst the asset class with the lowest absolute return was Cash (+12.47%)</li><li>Attribution analysis relative to SAA shows nan having the highest impact on value add at (+nan%).</li><li>Whereas, nan was found to have a (+nan%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
