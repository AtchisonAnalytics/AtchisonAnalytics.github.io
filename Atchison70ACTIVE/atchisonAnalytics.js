    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 70 SMA as at 31 December 2025</h2>
                    ...
                    <p>The Atchison Active 70 SMA delivered -0.2% for the month, and 0.4% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 70 SMA delivered 8.0%, materially beating Inflation by 4.2%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Active 70 SMA has marginally underperformed over the last 12 months. </p>
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+15.73%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.76%)</li><li>The asset class with the highest absolute return was International Shares (+65.21%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+11.11%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+2.61%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.28%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
