    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 70 SMA as at 31 March 2025</h2>
                    ...
                    <p>The Atchison Active 70 SMA delivered -2.0% for the month, and -0.0% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 70 SMA delivered 6.1%, materially beating Inflation by 3.9%. 
                    ...
                    <p>Since inception of the strategy, the Atchison Active 70 SMA has delivered 11.5%, significantly beating Inflation by 8.3%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+12.51%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.58%)</li><li>The asset class with the highest absolute return was International Shares (+48.22%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+9.06%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+3.46%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.24%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
