    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 70 SMA as at 30 April 2025</h2>
                    ...
                    <p>The Atchison Active 70 SMA delivered 0.4% for the month, and -1.9% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 70 SMA delivered 9.0%, significantly beating Inflation by 5.7%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+11.91%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.61%)</li><li>The asset class with the highest absolute return was International Shares (+43.99%)</li><li>Whilst the asset class with the lowest absolute return was Cash (+10.39%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+4.23%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.91%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
