    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos ESG Growth (Total)</h1>
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Bongiornos ESG Growth (Total) delivered 0.1% for the month, and 1.1% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos ESG Growth (Total) delivered 21.7%, significantly beating Inflation by 18.4%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos ESG Growth (Total) has significantly outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos ESG Growth (Total) has delivered 9.2%, significantly beating Inflation by 4.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos ESG Growth (Total) has  outperformed since inception of the strategy. </p>
