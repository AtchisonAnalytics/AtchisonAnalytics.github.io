        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    ...
                    <p>The Atchison Direct - Australian Shares 20 Equal Weight delivered -3.5% for the month, and -1.7% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Direct - Australian Shares 20 Equal Weight delivered 6.0%, materially beating Inflation by 4.0%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Direct - Australian Shares 20 Equal Weight has materially underperformed over the last 12 months. </p>
