    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos ESG Balanced (Total)</h1>
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Bongiornos ESG Balanced (Total) delivered -0.3% for the month, and 0.7% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos ESG Balanced (Total) delivered 17.5%, significantly beating Inflation by 14.2%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos ESG Balanced (Total) has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos ESG Balanced (Total) has delivered 7.1%, significantly beating Inflation by 2.5%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos ESG Balanced (Total) has  outperformed since inception of the strategy. </p>
