    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active Australian Shares SMA as at 31 March 2026</h2>
                    ...
                    <p>The Atchison Active Australian Shares SMA delivered -7.8% for the month, and -5.8% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active Australian Shares SMA delivered 6.7%, materially beating Inflation by 3.0%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Active Australian Shares SMA has  outperformed over the last 12 months. </p>
                    ...
                    <ul><li>On a weighted basis, the largest holding contributor to the portfolio outcome has been iShares Core S&P/ASX 200 ETF</li><li>The holding that contributed the least to portfolio return was Hyperion Australian Growth Companies Fund</li><li>The current holding with the highest absolute return has been Ausbil Australian SmallCap Fund<li>Whilst the current holding with the lowest absolute return has been Hyperion Australian Growth Companies Fund</li></ul>
                    <p>The iShares Core S&P/ASX 200 ETF provides a low-cost price and yield performance of the market, as indicated by the S&P/ASX 200 Accumulation Index, less the investment management fee of 0.05 per cent pa. </p><p></p><p>Ausbil is a style agnostic manager, aiming to exploit opportunities in small (listed ASX companies with a market value of between A$300 million to A$2 billion) and micro-cap markets (listed ASX companies with a market value of less than A$300 million). Typically, active small-cap managers over the long-term have the capacity to outperform their benchmark due to the inefficiencies within the index consisting of roughly 2000 names. </p><p></p>
                    
        <h2>MARKET OVERVIEW - February 2026</h2>
        <ul>
            <li>The ASX200 lifted 4% for the month of February. Sector dynamics drove the divergence, with Financials and Materials within the S&P/ASX 200 each climbing close to 9%. In contrast, Health Care fell sharply and Information Technology remained under pressure, now significantly below its July 2025 peak amid concerns around AI disruption.</li>
            <li>The ASX 20 advanced about 8%, while smaller companies lagged and both the ASX Small Ordinaries and NZX SmallCap indices declined.</li>
            <li>South Korea led regional markets once again, with the Korea BMI advancing roughly 20% for the month and around 52% year-to-date.</li>
            <li>U.S. equities faced headwinds in February, as heightened scrutiny around AI-related capital spending and its implications for corporate profitability weighed on large-cap technology companies. The S&P 500 recorded its third weekly decline.</li>
            <li>Sector performance among large caps was uneven, reflecting a pullback in enthusiasm for major technology companies and a move toward more defensive positioning. Utilities delivered the strongest gains, while Communication Services and Consumer Discretionary sectors declined.</li>
            <li>Factor strategies largely produced positive results, with quality, dividend and low-volatility approaches outperforming. Value-oriented strategies also exceeded growth-focused approaches during the month.</li>
            <li>In Europe, most sectors delivered positive returns, with Communication Services and Real Estate producing particularly strong gains, while Financials was the only sector to decline during the month.</li>
            <li>Australian 10-year government bond yields eased to 4.29%, while expectations for domestic monetary easing expected later in 2026. </li>
            <li>U.S. 10-year Treasury yields declined to 4.21%, with interest rate markets increasingly assigning a greater probability to a third Federal Reserve rate reduction later in the year.</li>
            <li>Recent escalation in the Middle East has increased geopolitical uncertainty and reintroduced energy supply risk into market pricing. Investors are assessing whether higher oil prices could reignite inflation, slow growth, or both. </li>
            <li>We maintain, meaningful exposure to global infrastructure, structural allocation to energy stocks, dedicated gold allocation, high-quality fixed income, active currency hedging.  </li>                  
