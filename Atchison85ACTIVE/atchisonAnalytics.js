    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Unknown Portfolio as at 31 August 2025</h2>
                    ...
                    <p>The Unknown Portfolio delivered 1.6% for the month, and 1.8% over the quarter. </p>
                    <p>Over the last 12 months, the Unknown Portfolio delivered 1.8%,  beating Inflation by 1.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Unknown Portfolio has materially outperformed over the last 12 months. </p>
