    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos ESG Aggressive (Total)</h1>
                    <h4>Updated to: 21 November 2024</h2>
                    <h4>Inception:  28 February 2022</h2>
                    <br>
                    <h2>PORTFOLIO PERFORMANCE</h2>
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Bongiornos ESG Aggressive (Total) delivered 0.5% for the month, and 1.5% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos ESG Aggressive (Total) delivered 25.0%, significantly beating Inflation by 21.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos ESG Aggressive (Total) has significantly outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos ESG Aggressive (Total) has delivered 10.3%, significantly beating Inflation by 5.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos ESG Aggressive (Total) has  outperformed since inception of the strategy. </p>
                    
                    <p>All performance metrics listed above are net of appointed investment management fees but before tax. Where noted, the Since Inception date of this analysis is: 28 February 2022. All performance is based on daily asset returns using portfolio target weights. Where a portfolio target weight change has been input into the dataset, it is assumed to have been applied as at the end of day asset valuations. </p>          
