    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 55 SMA as at 30 April 2025</h2>
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+9.44%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.92%)</li><li>The asset class with the highest absolute return was International Shares (+43.74%)</li><li>Whilst the asset class with the lowest absolute return was Cash (+10.40%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+3.26%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.60%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
