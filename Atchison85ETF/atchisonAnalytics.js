    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 85 SMA as at 30 June 2025</h2>
                    ...
                    <p>The Atchison Dynamic ETF 85 SMA delivered 1.4% for the month, and 6.4% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 85 SMA delivered 15.3%, significantly beating Inflation by 13.2%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+18.93%)</li><li>The asset class that contributed the least to portfolio return was Long Duration at (+0.45%)</li><li>The asset class with the highest absolute return was International Shares (+55.78%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+9.59%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+0.87%).</li><li>Whereas, Manager Effect (net fees) was found to have a (+0.40%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
