        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Unknown Portfolio delivered 2.2% for the month, and 2.9% over the quarter. </p>
                    <p>Over the last 12 months, the Unknown Portfolio delivered 13.8%, significantly beating Inflation by 10.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), Unknown Portfolio has marginally outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Unknown Portfolio has delivered 3.4%,  beating Inflation by 0.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Unknown Portfolio has marginally underperformed since inception of the strategy. </p>
