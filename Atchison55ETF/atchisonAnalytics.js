    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 55 SMA as at 28 February 2026</h2>
                    ...
                    <p>The Atchison Dynamic ETF 55 SMA delivered 1.3% for the month, and 2.0% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 55 SMA delivered 9.8%, significantly beating Inflation by 6.0%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+14.04%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.98%)</li><li>The asset class with the highest absolute return was International Shares (+67.64%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+11.24%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+0.71%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.69%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
