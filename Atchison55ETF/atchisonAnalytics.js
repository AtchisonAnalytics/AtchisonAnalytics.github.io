        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Atchison Dynamic ETF 55 SMA delivered 1.5% for the month, and 4.8% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 55 SMA delivered 17.2%, significantly beating Inflation by 13.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Dynamic ETF 55 SMA has significantly outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Atchison Dynamic ETF 55 SMA has delivered 13.1%, significantly beating Inflation by 9.1%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+10.54%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.00%)</li><li>The asset class with the highest absolute return was International Shares (+41.53%)</li><li>Whilst the asset class with the lowest absolute return was Cash (+7.49%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+1.40%).</li><li>Whereas, Manager Effect (net fees) was found to have a (+0.26%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
