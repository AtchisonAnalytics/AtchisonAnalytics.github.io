    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 55 SMA as at 31 December 2025</h2>
                    ...
                    <p>The Atchison Dynamic ETF 55 SMA delivered 0.1% for the month, and 0.7% over the quarter. </p>
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+14.07%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.95%)</li><li>The asset class with the highest absolute return was International Shares (+68.20%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+9.74%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+0.79%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-1.13%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
