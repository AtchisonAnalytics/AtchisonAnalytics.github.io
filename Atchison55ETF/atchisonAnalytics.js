    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 55 SMA as at 31 December 2024</h2>
                    ...
                    <p>The Atchison Dynamic ETF 55 SMA delivered -0.6% for the month, and 1.5% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 55 SMA delivered 11.4%, significantly beating Inflation by 8.6%. 
                    ...
                    <p>Since inception of the strategy, the Atchison Dynamic ETF 55 SMA has delivered 10.9%, significantly beating Inflation by 7.3%. 
            ...
            case '1-performance':
                content = `
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed to the most to the portfolio return was International Shares at (+10.54%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.00%)</li><li>The asset class with the highest absolute return was International Shares (+46.43%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+7.60%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+0.29%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-1.89%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
