    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    <h1>Yield FP - Ethical Portfolio</h1>
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Yield FP - Ethical Portfolio delivered 3.6% for the month, and 5.5% over the quarter. </p>
                    <p>Over the last 12 months, the Yield FP - Ethical Portfolio delivered 21.1%, significantly beating Inflation by 18.1%. 
                    Relative to the Peer Group (FE AMI Peer Average), Yield FP - Ethical Portfolio has significantly outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Yield FP - Ethical Portfolio has delivered 15.0%, significantly beating Inflation by 11.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Yield FP - Ethical Portfolio has significantly outperformed since inception of the strategy. </p>
