    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active Floating Rate SMA as at 30 September 2025</h2>
                    ...
                    <p>The Atchison Active Floating Rate SMA delivered 0.4% for the month, and 1.1% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active Floating Rate SMA delivered 4.8%, materially beating Inflation by 2.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Active Floating Rate SMA has  outperformed over the last 12 months. </p>
