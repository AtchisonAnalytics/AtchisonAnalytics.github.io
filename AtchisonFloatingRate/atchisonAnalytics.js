        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Atchison Active Floating Rate SMA delivered 0.6% for the month, and 2.1% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active Floating Rate SMA delivered 7.1%, materially beating Inflation by 3.8%. 
