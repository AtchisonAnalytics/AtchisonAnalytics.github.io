    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active Real Assets SMA as at 31 January 2025</h2>
                    ...
                    <p>The Atchison Active Real Assets SMA delivered 1.6% for the month, and -1.5% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active Real Assets SMA delivered 9.6%, significantly beating Inflation by 6.8%. 
                    ...
                    <p>Since inception of the strategy, the Atchison Active Real Assets SMA has delivered 7.3%, significantly beating Inflation by 3.9%. 
                    ...
                    <ul><li>On a weighted basis, the largest holding contributor to the portfolio outcome has been BlackRock iShares WholeSale Australian Listed Property Index</li><li>The holding that contributed the least to portfolio return was Invesco Global Real Estate Fund - Class A</li><li>The current holding with the highest absolute return has been BlackRock iShares WholeSale Australian Listed Property Index<li>Whilst the current holding with the lowest absolute return has been ClearBridge RARE Infrastructure Income Fund - Hedged</li></ul>
                    <p>The iShares Wholesale Australian Listed Property Index Fund (S Class) tracks the S&P/ASX 300 A-REIT (TR) index, less investment management fee of 0.20 per cent pa, and as such focuses on Australian listed property securities, before fees. Suitable if seeking stability and income potential through real estate investments within Australia.</p><p></p><p></p><p>Clearbridge RARE Infrastructure, founded in 2006, offers investors a long-term reliable earnings stream, which is relatively resilient to changing economic conditions and is largely protected from inflation (based on income indexed to inflation). As such, the asset class typically displays less volatility than broader equities with a lower correlation to other asset classes over the medium to long term. </p>
