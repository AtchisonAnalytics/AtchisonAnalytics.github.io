        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    ...
                    <ul><li>On a weighted basis, the largest holding contributor to the portfolio outcome has been ClearBridge RARE Infrastructure Income Fund - Hedged</li><li>The holding that contributed the least to portfolio return was BlackRock iShares WholeSale Australian Listed Property Index</li><li>The current holding with the highest absolute return has been ClearBridge RARE Infrastructure Income Fund - Hedged<li>Whilst the current holding with the lowest absolute return has been BlackRock iShares Global Listed Property Index</li></ul>
                    <p>Clearbridge RARE Infrastructure, founded in 2006, offers investors a long-term reliable earnings stream, which is relatively resilient to changing economic conditions and is largely protected from inflation (based on income indexed to inflation). As such, the asset class typically displays less volatility than broader equities with a lower correlation to other asset classes over the medium to long term. </p><p>The iShares Wholesale Australian Listed Property Index Fund (S Class) tracks the S&P/ASX 300 A-REIT (TR) index, less investment management fee of 0.20 per cent pa, and as such focuses on Australian listed property securities, before fees. Suitable if seeking stability and income potential through real estate investments within Australia.</p><p></p><p>iShares Global Listed Property Index Fund (Hedged S Class) delivers investors the market's performance of the FTSE EPRA/NAREIT Developed Index Net TR Index (AUD Hedged), less investment management fees of 0.15 per cent. This Fund provides diversification within the property asset class and is a cost-efficient method of accessing the global listed property sector.</p>
