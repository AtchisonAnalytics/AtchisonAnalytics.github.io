    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 55 SMA as at 31 March 2026</h2>
                    ...
                    <p>The Atchison Active 55 SMA delivered -3.8% for the month, and -2.9% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 55 SMA delivered 4.0%, marginally beating Inflation by 0.3%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+10.54%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+1.11%)</li><li>The asset class with the highest absolute return was International Shares (+53.46%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+10.69%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+3.36%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-1.94%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
