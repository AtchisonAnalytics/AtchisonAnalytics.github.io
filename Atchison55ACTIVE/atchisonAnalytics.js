    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 55 SMA as at 28 February 2025</h2>
                    ...
                    <p>The Atchison Active 55 SMA delivered -0.1% for the month, and 1.3% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 55 SMA delivered 9.8%, significantly beating Inflation by 7.1%. 
                    ...
                    <p>Since inception of the strategy, the Atchison Active 55 SMA has delivered 11.2%, significantly beating Inflation by 8.0%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+10.88%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.86%)</li><li>The asset class with the highest absolute return was International Shares (+54.28%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+9.09%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+2.14%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.09%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
