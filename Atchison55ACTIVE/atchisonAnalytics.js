    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 55 SMA as at 31 October 2025</h2>
                    ...
                    <p>The Atchison Active 55 SMA delivered 1.0% for the month, and 2.7% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 55 SMA delivered 9.5%, significantly beating Inflation by 7.2%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+12.53%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+1.03%)</li><li>The asset class with the highest absolute return was International Shares (+66.22%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+12.41%)</li><li>Attribution analysis relative to SAA shows nan having the highest impact on value add at (+nan%).</li><li>Whereas, nan was found to have a (+nan%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
