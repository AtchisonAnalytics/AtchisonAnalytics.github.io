    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 55 SMA as at 28 February 2026</h2>
                    ...
                    <p>The Atchison Active 55 SMA delivered 0.7% for the month, and 0.7% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 55 SMA delivered 6.5%, materially beating Inflation by 2.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Active 55 SMA has materially underperformed over the last 12 months. </p>
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+12.22%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+1.10%)</li><li>The asset class with the highest absolute return was International Shares (+63.89%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+12.51%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+3.43%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-1.58%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
