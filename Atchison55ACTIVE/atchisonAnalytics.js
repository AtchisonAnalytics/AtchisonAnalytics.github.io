    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active 55 SMA as at 30 September 2025</h2>
                    ...
                    <p>The Atchison Active 55 SMA delivered 0.5% for the month, and 3.1% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active 55 SMA delivered 8.6%, significantly beating Inflation by 6.5%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Active 55 SMA has marginally underperformed over the last 12 months. </p>
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+11.81%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+1.02%)</li><li>The asset class with the highest absolute return was International Shares (+61.76%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+11.99%)</li><li>Attribution analysis relative to SAA shows nan having the highest impact on value add at (+nan%).</li><li>Whereas, nan was found to have a (+nan%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
