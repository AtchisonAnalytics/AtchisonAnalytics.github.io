    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 70 SMA as at 30 June 2025</h2>
                    ...
                    <p>The Atchison Dynamic ETF 70 SMA delivered 1.3% for the month, and 5.5% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 70 SMA delivered 13.6%, significantly beating Inflation by 11.5%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+15.14%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.69%)</li><li>The asset class with the highest absolute return was International Shares (+55.29%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+9.60%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+2.02%).</li><li>Whereas, Manager Effect (net fees) was found to have a (+0.19%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
