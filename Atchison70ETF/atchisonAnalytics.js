    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 70 SMA as at 31 March 2026</h2>
                    ...
                    <p>The Atchison Dynamic ETF 70 SMA delivered -5.0% for the month, and -3.1% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 70 SMA delivered 7.5%, materially beating Inflation by 3.9%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+15.53%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.82%)</li><li>The asset class with the highest absolute return was International Shares (+56.75%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+9.73%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+1.05%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.12%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
