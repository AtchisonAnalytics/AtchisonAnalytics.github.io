    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 70 SMA as at 31 January 2025</h2>
                    ...
                    <p>The Atchison Dynamic ETF 70 SMA delivered 2.6% for the month, and 4.7% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 70 SMA delivered 15.0%, significantly beating Inflation by 12.2%. 
                    ...
                    <p>Since inception of the strategy, the Atchison Dynamic ETF 70 SMA has delivered 13.6%, significantly beating Inflation by 10.2%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+14.78%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.00%)</li><li>The asset class with the highest absolute return was International Shares (+50.49%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+7.78%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (-0.75%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-2.25%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
