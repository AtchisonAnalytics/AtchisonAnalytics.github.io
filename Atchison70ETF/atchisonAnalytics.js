    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 70 SMA as at 30 April 2025</h2>
                    ...
                    <p>The Atchison Dynamic ETF 70 SMA delivered 1.0% for the month, and -2.2% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 70 SMA delivered 9.8%, significantly beating Inflation by 6.6%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+13.20%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.55%)</li><li>The asset class with the highest absolute return was International Shares (+42.88%)</li><li>Whilst the asset class with the lowest absolute return was Alternatives (+8.20%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+1.99%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-1.66%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
