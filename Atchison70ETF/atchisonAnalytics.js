    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 70 SMA as at 31 December 2025</h2>
                    ...
                    <p>The Atchison Dynamic ETF 70 SMA delivered 0.2% for the month, and 0.9% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 70 SMA delivered 11.4%, significantly beating Inflation by 7.6%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+18.29%)</li><li>The asset class that contributed the least to portfolio return was Cash at (+0.77%)</li><li>The asset class with the highest absolute return was International Shares (+68.98%)</li><li>Whilst the asset class with the lowest absolute return was Long Duration (+10.00%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+1.21%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-0.17%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
