    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active International Shares SMA as at 30 November 2025</h2>
                    ...
                    <p>The Atchison Active International Shares SMA delivered -0.4% for the month, and 3.8% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active International Shares SMA delivered 10.5%, significantly beating Inflation by 6.7%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Active International Shares SMA has  underperformed over the last 12 months. </p>
