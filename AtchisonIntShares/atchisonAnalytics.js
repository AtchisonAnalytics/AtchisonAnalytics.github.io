    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Active International Shares SMA as at 30 June 2025</h2>
                    ...
                    <p>The Atchison Active International Shares SMA delivered 2.3% for the month, and 4.4% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Active International Shares SMA delivered 11.0%, significantly beating Inflation by 8.9%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Active International Shares SMA has significantly underperformed over the last 12 months. </p>
