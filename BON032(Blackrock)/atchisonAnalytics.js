    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '1-performance':
                content = `
                    <h1>Bongiornos Balanced DIV (Blackrock)</h1>
                    ...
                    <hr style="border-color: #1DC8F2; width: 80%; margin: 0 auto;">
                    <br>                    
                    <p>The Bongiornos Balanced DIV (Blackrock) delivered 2.1% for the month, and 3.2% over the quarter. </p>
                    <p>Over the last 12 months, the Bongiornos Balanced DIV (Blackrock) delivered 15.7%, significantly beating Inflation by 12.8%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Balanced DIV (Blackrock) has materially outperformed over the last 12 months. </p>
                    
                    
                    
                    
                    <p>Since inception of the strategy, the Bongiornos Balanced DIV (Blackrock) has delivered 10.1%, significantly beating Inflation by 6.3%. 
                    Relative to the Peer Group (FE AMI Peer Average), Bongiornos Balanced DIV (Blackrock) has  outperformed since inception of the strategy. </p>
