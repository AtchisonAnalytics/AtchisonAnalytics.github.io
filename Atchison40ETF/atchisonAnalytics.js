    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 40 SMA as at 30 June 2025</h2>
                    ...
                    <p>The Atchison Dynamic ETF 40 SMA delivered 1.0% for the month, and 3.7% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 40 SMA delivered 8.8%, significantly beating Inflation by 6.6%. 
                    Relative to the Peer Group (FE AMI Peer Average), Atchison Dynamic ETF 40 SMA has materially outperformed over the last 12 months. </p>
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+9.13%)</li><li>The asset class that contributed the least to portfolio return was Alternatives at (+0.24%)</li><li>The asset class with the highest absolute return was International Shares (+54.06%)</li><li>Whilst the asset class with the lowest absolute return was Alternatives (+4.36%)</li><li>Attribution analysis relative to SAA shows Tactical Allocation Effect having the highest impact on value add at (+1.48%).</li><li>Whereas, Manager Effect (net fees) was found to have a (-1.43%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
        ...
        <br>
            ...
            case '1-performance':
                content = `
                    <h1>Atchison Dynamic ETF 40 SMA</h1>
