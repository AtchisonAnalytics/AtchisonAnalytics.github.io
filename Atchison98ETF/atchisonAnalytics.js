    ...
    function loadContent(page) {
        ...
        switch(page) {
            ...
            case '0-summary':
                content = `
                    <h2>Summary Dashboard for Atchison Dynamic ETF 98 SMA as at 30 June 2025</h2>
                    ...
                    <p>The Atchison Dynamic ETF 98 SMA delivered 1.5% for the month, and 6.9% over the quarter. </p>
                    <p>Over the last 12 months, the Atchison Dynamic ETF 98 SMA delivered 16.8%, significantly beating Inflation by 14.7%. 
                    ...
                    <ul><li>On a weighted basis, the asset class that contributed the most to the portfolio return was International Shares at (+21.00%)</li><li>The asset class that contributed the least to portfolio return was Long Duration at (+0.00%)</li><li>The asset class with the highest absolute return was International Shares (+56.05%)</li><li>Whilst the asset class with the lowest absolute return was Cash (+10.99%)</li><li>Attribution analysis relative to SAA shows Manager Effect (net fees) having the highest impact on value add at (+0.83%).</li><li>Whereas, Tactical Allocation Effect was found to have a (-1.03%) impact on relative performance of the portfolio.</li></ul>
                    <p></p><p></p><p></p><p></p>
